# Implementation of the groupchat messenger client in python
...
print(f"Connected to server at ('{serverName}', '{serverPort}') , please send your name");
